...
public class AsmDao extends BaseMysqlDao {
	...
	private static String cacheKey(AppPlatformBo appPlatform) {
		return cacheKeyAppPlatform(appPlatform.getAppId(),
	...
	public static PlatformBo create(PlatformBo platform) {
		final String[] COLUMNS = new String[] { "pid", "pis_enabled", "ptitle",
				"picon16", "picon24", "picon32", "picon48", "picon64" };
		final Object[] VALUES = new Object[] { platform.getId(),
				platform.isEnabled() ? 1 : 0, platform.getTitle(),
				platform.getIcon16(), platform.getIcon24(),
				platform.getIcon32(), platform.getIcon48(),
				platform.getIcon64() };
	...
	public static PlatformBo getPlatform(String id) {
		...
		if (dbRow == null) {
			...
			final String SQL = MessageFormat.format(SQL_TEMPLATE,
					TABLE_PLATFORM, PlatformBo.COL_ID,
					PlatformBo.COL_IS_ENABLED, PlatformBo.COL_TITLE,
					PlatformBo.COL_ICON_16, PlatformBo.COL_ICON_24,
					PlatformBo.COL_ICON_32, PlatformBo.COL_ICON_48,
					PlatformBo.COL_ICON_64);
			final Object[] WHERE_VALUES = new Object[] { id };
			List<Map<String, Object>> dbResult = select(SQL, WHERE_VALUES);
			dbRow = dbResult != null && dbResult.size() > 0 ? dbResult.get(0)
					: null;
			putToCache(CACHE_KEY, dbRow);
		}
		return dbRow != null ? (PlatformBo) new PlatformBo().fromMap(dbRow)
				: null;
	}
	...
	public static PlatformBo[] getAllPlatforms() {
		...
		if (dbRows != null) {
			for (Map<String, Object> dbRow : dbRows) {
				String id = DPathUtils.getValue(dbRow, PlatformBo.COL_ID,
						String.class);
	...
	public static PlatformBo update(PlatformBo platform) {
		if (platform.isDirty()) {
			...
			final String[] COLUMNS = new String[] { "pis_enabled", "ptitle",
					"picon16", "picon24", "picon32", "picon48", "picon64" };
	...
	public static UsergroupBo getUsergroup(String id) {
		...
		if (dbRow == null) {
			...
			final String SQL = MessageFormat.format(SQL_TEMPLATE,
					TABLE_USERGROUP, UsergroupBo.COL_ID, UsergroupBo.COL_TITLE);
			final Object[] WHERE_VALUES = new Object[] { id };
			List<Map<String, Object>> dbResult = select(SQL, WHERE_VALUES);
			dbRow = dbResult != null && dbResult.size() > 0 ? dbResult.get(0)
					: null;
		...
		return dbRow != null ? (UsergroupBo) new UsergroupBo().fromMap(dbRow)
				: null;
	}
	...
	public static UsergroupBo update(UsergroupBo usergroup) {
		if (usergroup.isDirty()) {
			...
			update(TABLE_USERGROUP, COLUMNS, VALUES, WHERE_COLUMNS,
					WHERE_VALUES);
	...
	public static UserBo create(UserBo user) {
		final String[] COLUMNS = new String[] { "uid", "ulogin_name",
				"upassword", "uemail", "ugroup_id", "utimestamp_create" };
		final Object[] VALUES = new Object[] { user.getId(),
				user.getLoginName(), user.getPassword(), user.getEmail(),
	...
	public static UserBo getUser(String id) {
		...
		if (dbRow == null) {
			...
			final String SQL = MessageFormat.format(SQL_TEMPLATE, TABLE_USER,
					UserBo.COL_ID, UserBo.COL_LOGIN_NAME, UserBo.COL_PASSWORD,
					UserBo.COL_EMAIL, UserBo.COL_GROUP_ID,
	...
	public static UserBo getUserByLoginname(String loginname) {
		...
		final String SQL = MessageFormat.format(SQL_TEMPLATE, TABLE_USER,
				UserBo.COL_ID, UserBo.COL_LOGIN_NAME);
		final Object[] WHERE_VALUES = new Object[] { loginname };
		List<Map<String, Object>> dbResult = select(SQL, WHERE_VALUES);
		Map<String, Object> dbRow = dbResult != null && dbResult.size() > 0 ? dbResult
				.get(0) : null;
	...
	public static UserBo update(UserBo user) {
		if (user.isDirty()) {
			...
			final String[] COLUMNS = new String[] { "upassword", "uemail",
					"ugroup_id" };
			final Object[] VALUES = new Object[] { user.getPassword(),
	...
	public static AppCategoryBo create(AppCategoryBo appCat) {
		final String[] COLUMNS = new String[] { "cid", "cparent_id",
				"cposition", "ctitle" };
		final Object[] VALUES = new Object[] { appCat.getId(),
				appCat.getParentId(), appCat.getPosition(), appCat.getTitle() };
	...
	public static AppCategoryBo getAppCategory(String id) {
		...
		if (dbRow == null) {
			...
			final String SQL = MessageFormat.format(SQL_TEMPLATE,
					TABLE_APP_CATEGORY, AppCategoryBo.COL_ID,
					AppCategoryBo.COL_PARENT_ID, AppCategoryBo.COL_POSITION,
		...
		return dbRow != null ? (AppCategoryBo) new AppCategoryBo()
				.fromMap(dbRow) : null;
	}
	...
	public static AppCategoryBo update(AppCategoryBo appCat) {
		if (appCat.isDirty()) {
			...
			final String[] COLUMNS = new String[] { "cparent_id", "cposition",
					"ctitle" };
			final Object[] VALUES = new Object[] { appCat.getParentId(),
			...
			update(TABLE_APP_CATEGORY, COLUMNS, VALUES, WHERE_COLUMNS,
					WHERE_VALUES);
	...
	public static ApplicationBo create(ApplicationBo app) {
		final String[] COLUMNS = new String[] { "aid", "acategory_id",
				"aposition", "atitle", "asummary" };
		final Object[] VALUES = new Object[] { app.getId(),
				app.getCategoryId(), app.getPosition(), app.getTitle(),
				app.getSummary() };
	...
	public static ApplicationBo getApplication(String id) {
		...
		if (dbRow == null) {
			...
			final String SQL = MessageFormat.format(SQL_TEMPLATE,
					TABLE_APPLICATION, ApplicationBo.COL_ID,
					ApplicationBo.COL_CAT_ID, ApplicationBo.COL_POSITION,
		...
		return dbRow != null ? (ApplicationBo) new ApplicationBo()
				.fromMap(dbRow) : null;
	}
	...
	public static ApplicationBo update(ApplicationBo app) {
		if (app.isDirty()) {
			...
			final String[] COLUMNS = new String[] { "acategory_id",
					"aposition", "atitle", "asummary" };
			final Object[] VALUES = new Object[] { app.getCategoryId(),
					app.getPosition(), app.getTitle(), app.getSummary() };
			final String[] WHERE_COLUMNS = new String[] { "aid" };
			final Object[] WHERE_VALUES = new Object[] { app.getId() };
			update(TABLE_APPLICATION, COLUMNS, VALUES, WHERE_COLUMNS,
					WHERE_VALUES);
	...
	public static AppPlatformBo create(AppPlatformBo appPlatform) {
		final String[] COLUMNS = new String[] { "app_id", "platform_id",
				"apis_enabled", "apversion", "aptimestamp_release",
				"aprelease_notes", "apurl_download" };
		final Object[] VALUES = new Object[] { appPlatform.getAppId(),
				appPlatform.getPlatformId(), appPlatform.isEnabled() ? 1 : 0,
	...
	public static AppPlatformBo getAppPlatform(String appId, String platformId) {
		...
		if (dbRow == null) {
			...
			final String SQL = MessageFormat.format(SQL_TEMPLATE,
					TABLE_APP_PLATFORM, AppPlatformBo.COL_APP_ID,
					AppPlatformBo.COL_PLATFORM_ID,
					AppPlatformBo.COL_IS_ENABLED, AppPlatformBo.COL_VERSION,
					AppPlatformBo.COL_TIMESTAMP_RELEASE,
					AppPlatformBo.COL_RELEASE_NOTES,
		...
		return dbRow != null ? (AppPlatformBo) new AppPlatformBo()
				.fromMap(dbRow) : null;
	}
	...
	public static AppPlatformBo[] getAppPlatforms(ApplicationBo app) {
		...
		if (dbRows != null) {
			for (Map<String, Object> dbRow : dbRows) {
				String appId = DPathUtils.getValue(dbRow,
						AppPlatformBo.COL_APP_ID, String.class);
				String platformId = DPathUtils.getValue(dbRow,
						AppPlatformBo.COL_PLATFORM_ID, String.class);
	...
	public static AppPlatformBo update(AppPlatformBo appPlatform) {
		if (appPlatform.isDirty()) {
			...
			final String[] COLUMNS = new String[] { "apis_enabled",
					"apversion", "aptimestamp_release", "aprelease_notes",
					"apurl_download" };
			final Object[] VALUES = new Object[] {
					appPlatform.isEnabled() ? 1 : 0, appPlatform.getVersion(),
					appPlatform.getTimestampRelease(),
					appPlatform.getReleaseNotes(), appPlatform.geturlDownload() };
			final String[] WHERE_COLUMNS = new String[] { "app_id",
					"platform_id" };
			final Object[] WHERE_VALUES = new Object[] {
					appPlatform.getAppId(), appPlatform.getPlatformId() };
			update(TABLE_APP_PLATFORM, COLUMNS, VALUES, WHERE_COLUMNS,
					WHERE_VALUES);
